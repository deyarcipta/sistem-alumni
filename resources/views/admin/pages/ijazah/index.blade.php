...
@section('title', 'Data Ijazah Alumni')

@section('content')
<div class="container">
    <h3 class="mb-4">Data Ijazah Alumni</h3>
    {{-- @if (session('success'))
    ...
    <div class="card">
        ...
        <div class="card-body table-responsive">
            <table class="table table-bordered" id="ijazahTable">
                <thead>
                    <tr>
                        <th>No</th>
                        <th>Nama Alumni</th>
                ...
                <tbody>
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title">Detail Ijazah</h5>
                    ...
                    <div class="modal fade" id="modalEdit{{ $item->id_dokumen }}" tabindex="-1">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <form action="{{ route('admin.ijazah.update', $item->id_dokumen) }}" method="POST" enctype="multipart/form-data">
                                    @csrf @method('PUT')
                                    <div class="modal-header">
                    ...
                    <div class="modal fade" id="modalHapus{{ $item->id_dokumen }}" tabindex="-1">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <form action="{{ route('admin.ijazah.destroy', $item->id_dokumen) }}" method="POST">
                                    @csrf @method('DELETE')
                                    ...
                                    <div class="modal-body">
                                        Yakin ingin menghapus dokumen ijazah <strong>{{ $item->alumni->nama }}</strong>?
                                    </div>
                                    <div class="modal-footer">
...
<div class="modal fade" id="modalTambah" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('admin.ijazah.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-header">
...
<div class="modal fade" id="modalImport" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('admin.ijazah.import') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-header d-flex justify-content-between align-items-center">
                    <h5 class="modal-title">Import Data Ijazah</h5>
                    <a href="{{ asset('storage/template/template_import_ijazah.xlsx') }}" class="btn btn-sm btn-success">
...
<div class="modal fade" id="modalUploadZip" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('admin.ijazah.upload.zip') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <small class="form-text text-muted">File harus dalam format .zip berisi dokumen ijazah (.pdf) yang dinamai dengan ID alumni (contoh: <code>12345.pdf</code>).</small>
                    </div>
                </div>
                <div class="modal-footer">
...
<script>
    $(document).ready(function() {
        let jumlahData = {{ $ijazah->count() }};
        if (jumlahData > 0) {
            $('#ijazahTable').DataTable({
                "language": {
                    "search": "Cari:",
